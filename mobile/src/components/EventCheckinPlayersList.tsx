...
type EventCheckinPlayersListProps = {
  event: Event,
...
export function EventCheckinPlayersList({ event, eventPlayers, onPlayersChanged, isRefreshing, onRefresh, listHeader }: EventCheckinPlayersListProps): React.ReactNode {
