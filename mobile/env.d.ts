...
export type CoercedEnvSchema = {
  /**
   * **NODE_ENV**  
   * Drives which .env.<env> file is loaded. EAS sets this to "production" for prod builds.  
  ...
  /**
   * **API_BASE_URL**  
   * Base URL of the Hono API the mobile app talks to.  
  ...
  /**
   * **IMAGEKIT_PUBLIC_KEY**  
   * ImageKit public key, used by the imagekit-javascript SDK in the app.  
  ...
  /**
   * **SENTRY_DSN**  
   * Sentry DSN for @sentry/react-native. Public by design.  
   * Optional: dev builds skip Sentry; only .env.production sets a real value.  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M24%2021V9h-2v14h8v-2zm-4-6v-4c0-1.103-.897-2-2-2h-6v14h2v-6h1.48l2.335%206h2.145l-2.333-6H18c1.103%200%202-.897%202-2m-6-4h4v4h-4zM8%2023H4c-1.103%200-2-.897-2-2V9h2v12h4V9h2v12c0%201.103-.897%202-2%202%22%2F%3E%3C%2Fsvg%3E)   
   *   
...
type _CoercedEnvSchema_d39e2b3f = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_d39e2b3f> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_d39e2b3f, 'NODE_ENV' | 'API_BASE_URL' | 'IMAGEKIT_URL' | 'IMAGEKIT_PUBLIC_KEY' | 'SENTRY_DSN'>> {}
}
...
type _EnvSchemaAsStrings_d39e2b3f = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_d39e2b3f {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_d39e2b3f {}
  }
}